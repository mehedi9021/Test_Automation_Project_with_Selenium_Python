...
class Test_004_itemAddtoCart:
    ...
    def test_itemAddtoCart(self, setup):
        self.logger.info("***** Starting Test_004_itemAddtoCart *****")
        self.driver = setup
        ...
        if 'Search No Result' in self.msg:
            ...
            if 'For OnePlus 9 Pro Shockproof Transparent liquid Cristal clear long time useable soft premium protective back cover' in self.msg:
                ...
                self.logger.error("***** Item Not Found *****")
                self.driver.save_screenshot("C:\\Users\\User\\PycharmProjects\\Daraz_TestAutomation\\screenshots\\test_004_itemAddtoCart.png")
                self.driver.close()
                assert False
        ...
        self.logger.info("***** Completed Test_004_itemAddtoCart *****")
