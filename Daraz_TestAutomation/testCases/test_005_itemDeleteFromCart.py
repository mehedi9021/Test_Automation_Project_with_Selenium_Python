...
class Test_005_itemDeleteFromCartPage:
    ...
    def test_login(self, setup):
        ...
        if 'There are no items in this cart' in self.msg:
            ...
            if 'There are no items in this cart' in self.msg:
                ...
                self.driver.save_screenshot("C:\\Users\\User\\PycharmProjects\\Daraz_TestAutomation\\screenshots\\test_005_itemDeleteFromCartPage.png")
                self.driver.close()
                assert False
            assert True
        ...
        self.logger.info("***** Completed Test_005_itemDeleteFromCartPage *****")